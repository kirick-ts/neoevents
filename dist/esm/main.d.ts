...
export declare class NeoEventTarget<EL extends Record<string, Event> | undefined = undefined> extends EventTarget {
    private listeners;
    private addListener;
    /**
     ...
     */
    on<T extends string, E extends Event | undefined = undefined>(type: EL extends undefined ? T : T extends keyof EL ? T : keyof EL, listener: (event: E extends undefined ? EL extends undefined ? unknown : T extends keyof EL ? EL[T] : unknown : E) => void): () => void;
    /**
     ...
     */
    wait<T extends string, E extends Event | undefined = undefined>(type: EL extends undefined ? T : T extends keyof EL ? T : keyof EL): Promise<E extends undefined ? EL extends undefined ? unknown : T extends keyof EL ? EL[T] : unknown : E>;
    /**
